...
- [x] **Week 1 — Setup & Architecture** _(this session)_
      ...
      _Explicitly not done yet: any feature logic._
...
- [ ] **Weeks 10-11 — Sharing & Advanced Features**
      ...
      _Note: this is local-role/local-attribution only — actual multi-device invite/sync is Phase 2, since it needs a backend._
